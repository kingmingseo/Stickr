...
export const translations = {
  korean: {
    ...
    start: '시작하기',
    skip: '건너뛰기',
    skipMain: 'Gboard가 있어요',
    skipSub: '(건너뛰기)',
    next: '다음',
    viewServiceOnboarding: '서비스 소개 보기',
    whyGboard: '왜 Gboard가 필요한가요?',
    whyGboardDesc: '기본 키보드는 안드로이드에서 이미지 붙여넣기를 지원하지 않습니다. Gboard를 사용하면 스티커를 빠르게 붙여넣을 수 있어요.',
    
    // Gboard 온보딩
    gboardOnboardingTitle: 'Gboard가 필요해요',
    gboardOnboardingSubtitle: 'Stickr는 Gboard를 통해 스티커를 붙여넣어요',
    gboardInstallTitle1: '설정 앱 접근하기',
    gboardInstallTitle2: '키보드 설정 접근하기',
    gboardInstallTitle3: 'Gboard 활성화 하기',
    gboardInstallTitle4: '확인 버튼을 눌러주세요',
    gboardInstallTitle5: '기본 키보드 설정 탭 터치',
    gboardInstallTitle6: 'Gboard로 기본 키보드 변경',
    ...
    gboardSetupSubtitle2: '설정 -> 일반 -> 키보드 목록 ',
    gboardSetupSubtitle3: '설정 -> 일반 -> 키보드 목록 -> Gboard 선택',
    gboardSetupSubtitle4: 'Stickr는 Gboard와 통신하지 않으며 별도의 앱 입니다',
    gboardSetupSubtitle5: '설정 -> 일반 -> 키보드 목록 -> Gboard 활성화 \n-> 기본 키보드',
    gboardSetupSubtitle6: '설정 -> 일반 -> 키보드 목록 -> Gboard 활성화 \n-> 기본 키보드 -> Gboard 선택',
  ...
  english: {
    ...
    start: 'Get Started',
    skip: 'Skip',
    skipMain: 'I have Gboard',
    skipSub: '(Skip)',
    next: 'Next',
    viewServiceOnboarding: 'View App Intro',
    whyGboard: 'Why do I need Gboard?',
    whyGboardDesc: 'Default keyboard doesn\'t support image pasting on Android. Use Gboard to paste stickers quickly.',
    ...
    gboardInstallTitle1: 'Open Settings',
    gboardInstallTitle2: 'Tap Languages & input',
    gboardInstallTitle3: 'Tap On-screen keyboard',
    gboardInstallTitle4: 'Tap Manage keyboards',
    gboardInstallTitle5: 'Enable Gboard',
    gboardInstallTitle6: 'Tap Default keyboard setting',
    gboardInstallTitle7: 'Switch to Gboard, then done',
